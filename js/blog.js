...
class WebGloBlog {
  ...
  async subscribeToNewsletter(email, form) {
    ...
    try {
      ...
      // Track subscription
      this.trackEvent('Newsletter Subscription', { email: email });
      
      // Show special offer modal
      this.showSubscriptionBonus();
  ...
  showSubscriptionBonus() {
    // Create modal for free resource offer
    const modal = document.createElement('div');
    modal.className = 'fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4';
    modal.innerHTML = `
      <div class="bg-white rounded-3xl p-8 max-w-md w-full relative animate-pulse-once">
        ...
        <div class="text-center">
          <div class="w-16 h-16 bg-gradient-to-r from-[#df00ff] to-[#0cead9] rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <h3 class="text-2xl font-bold text-gray-900 mb-4">Welcome Bonus! 🎁</h3>
          <p class="text-gray-600 mb-6">As a thank you for subscribing, here's your free "Website Performance Checklist" ($47 value)</p>
          <a href="contact.html" class="inline-block w-full bg-gradient-to-r from-[#df00ff] to-[#0cead9] text-white font-semibold py-3 rounded-xl hover:shadow-lg transition-all duration-300 mb-4">
            Download Free Checklist
          </a>
          <p class="text-xs text-gray-500">This offer expires in 24 hours</p>
        </div>
      </div>
    `;
